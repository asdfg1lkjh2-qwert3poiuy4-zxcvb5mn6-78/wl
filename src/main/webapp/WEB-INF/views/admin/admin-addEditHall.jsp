...
<!-- Test Modal -->
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="row clearfix" id="productNameDiv">
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="name"  id="name"  placeholder="Hall Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="row clearfix form-group">
									<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 _thumnailImage" id="displayDiv">
										 <label for="comment" id="labelDisplayDiv">Hall Display Image</label>
									...
									<label for="comment" id="labelImagesDiv">Hall Description Images</label>
                            ...
                            <div class="header margin-left-right-zero marginb15">
									<div class="checkbox header-add">
										<label> <input type="checkbox" value="" id="freeProductsCheck" > <span
                            ...
                            <div class="header margin-left-right-zero marginb15">
                              ...
                              <div class="row clearfix" id="hallFeatures">
								<div class="col-sm-12 col-xs-12">
									<div class="col-sm-6 col-xs-12">
										<h4 style="margin-top:8%;">1) Do your hall provide extra bedrooms for the guests?</h4>
									</div>
									<div class="col-sm-1 col-xs-12">
										<div class="form-group mrgn-less-15">
											<div class="checkbox">
												<label class="labelCheckbox"> <input type="checkbox"
													name="checkBoxDiscountPercent" id="hallFeatureYes1">
													<span class="cr"><i
								   ...
								   <div class="col-sm-1 col-xs-12">
										<div class="form-group mrgn-less-15">
											<div class="checkbox">
												<label class="labelCheckbox"> <input type="checkbox"
													name="checkBoxDiscountPercent" id="hallFeatureNo1">
													<span class="cr"><i
								...
								<div class="col-sm-12 col-xs-12" style="margin-top:-3%;">
									<div class="col-sm-6 col-xs-12">
										<h4 style="margin-top:8%;">2) Do your hall has parking facility?</h4>
									</div>
									<div class="col-sm-1 col-xs-12">
										<div class="form-group mrgn-less-15">
											<div class="checkbox">
												<label class="labelCheckbox"> <input type="checkbox"
													name="checkBoxDiscountPercent" id="hallFeatureYes2">
													<span class="cr"><i
														class="cr-icon glyphicon glyphicon-ok"></i></span> Yes
												</label>
											</div>
								   ...
								   <div class="col-sm-1 col-xs-12">
										<div class="form-group mrgn-less-15">
											<div class="checkbox">
												<label class="labelCheckbox"> <input type="checkbox"
													name="checkBoxDiscountPercent" id="hallFeatureNo2">
													<span class="cr"><i
														class="cr-icon glyphicon glyphicon-ok"></i></span> No
												</label>
											</div>
								...
								<div class="col-sm-12 col-xs-12" style="margin-top:-3%;">
									<div class="col-sm-6 col-xs-12">
										<h4 style="margin-top:8%;">3) Do your hall has lounge for the guests?</h4>
									</div>
									<div class="col-sm-1 col-xs-12">
										<div class="form-group mrgn-less-15">
											<div class="checkbox">
												<label class="labelCheckbox"> <input type="checkbox"
													name="checkBoxDiscountPercent" id="hallFeatureYes3">
													<span class="cr"><i
														class="cr-icon glyphicon glyphicon-ok"></i></span> Yes
												</label>
											</div>
								   ...
								   <div class="col-sm-1 col-xs-12">
										<div class="form-group mrgn-less-15">
											<div class="checkbox">
												<label class="labelCheckbox"> <input type="checkbox"
													name="checkBoxDiscountPercent" id="hallFeatureNo3">
													<span class="cr"><i
														class="cr-icon glyphicon glyphicon-ok"></i></span> No
												</label>
											</div>
								...
								<div class="col-sm-12 col-xs-12" style="margin-top:-3%;">
									<div class="col-sm-6 col-xs-12">
										<h4 style="margin-top:8%;">4) Do your hall has any restrictions for crackers?</h4>
									</div>
									<div class="col-sm-1 col-xs-12">
										<div class="form-group mrgn-less-15">
											<div class="checkbox">
												<label class="labelCheckbox"> <input type="checkbox"
													name="checkBoxDiscountPercent" id="hallFeatureYes4">
													<span class="cr"><i
														class="cr-icon glyphicon glyphicon-ok"></i></span> Yes
												</label>
											</div>
								   ...
								   <div class="col-sm-1 col-xs-12">
										<div class="form-group mrgn-less-15">
											<div class="checkbox">
												<label class="labelCheckbox"> <input type="checkbox"
													name="checkBoxDiscountPercent" id="hallFeatureNo4">
													<span class="cr"><i
														class="cr-icon glyphicon glyphicon-ok"></i></span> No
												</label>
											</div>
								...
								<div class="col-sm-12 col-xs-12" style="margin-top:-3%;">
									<div class="col-sm-6 col-xs-12">
										<h4 style="margin-top:8%;">5) Do your hall has any extra space for making pandals if needed?</h4>
									</div>
									<div class="col-sm-1 col-xs-12">
										<div class="form-group mrgn-less-15">
											<div class="checkbox">
												<label class="labelCheckbox"> <input type="checkbox"
													name="checkBoxDiscountPercent" id="hallFeatureYes5">
													<span class="cr"><i
														class="cr-icon glyphicon glyphicon-ok"></i></span> Yes
												</label>
											</div>
								   ...
								   <div class="col-sm-1 col-xs-12">
										<div class="form-group mrgn-less-15">
											<div class="checkbox">
												<label class="labelCheckbox"> <input type="checkbox"
													name="checkBoxDiscountPercent" id="hallFeatureNo5">
													<span class="cr"><i
														class="cr-icon glyphicon glyphicon-ok"></i></span> No
												</label>
											</div>
								...
								<div class="col-sm-12 col-xs-12" style="margin-top:-3%;">
									<div class="col-sm-6 col-xs-12">
										<h4 style="margin-top:8%;">6) Do your hall has wifi connection for the guests?</h4>
									</div>
									<div class="col-sm-1 col-xs-12">
										<div class="form-group mrgn-less-15">
											<div class="checkbox">
												<label class="labelCheckbox"> <input type="checkbox"
													name="checkBoxDiscountPercent" id="hallFeatureYes6">
													<span class="cr"><i
														class="cr-icon glyphicon glyphicon-ok"></i></span> Yes
												</label>
											</div>
								   ...
								   <div class="col-sm-1 col-xs-12">
										<div class="form-group mrgn-less-15">
											<div class="checkbox">
												<label class="labelCheckbox"> <input type="checkbox"
													name="checkBoxDiscountPercent" id="hallFeatureNo6">
													<span class="cr"><i
														class="cr-icon glyphicon glyphicon-ok"></i></span> No
												</label>
											</div>
    ...
    Dropzone.options.singleUpload = {
			...
			init : function() {
				this.on("success", function(file, response) {
					...
					if(singleFiles === ""){
						singleFiles = "Hall"+"+@-"+classPathSingleFile[1]+"+@-"+dateTime+file.name;
					}else{
						singleFiles = singleFiles + "-,@_"+"Hall"+"+@-"+classPathSingleFile[1]+"+@-"+dateTime+file.name;
					}
	 			});
			},
    ...
    Dropzone.options.multipleUpload = {
			...
			init : function() {
				this.on("success", function(file, response) {
					...
					classPath = classPath.split("_");
					if(multipleFiles === ""){
						multipleFiles = "Hall"+"+@-"+classPath[1]+"+@-"+dateTime+file.name;
					}else{
						multipleFiles = multipleFiles + "-,@_"+ "Hall"+"+@-"+classPath[1]+"+@-"+dateTime+file.name;
					}
				...
				success : function(data) {
					...
					if (data.status) {
						...
						var abc = "<div class=\"btn-group bootstrap-select form-control show-tick\"><button type=\"button\" id=\"selectTab\" class=\"btn dropdown-toggle btn-default\" data-toggle=\"dropdown\" title=\"--Hall Type--\" aria-expanded=\"false\"><span class=\"filter-option pull-left\">--Hall Type--</span>&nbsp;<span class=\"bs-caret\"><span class=\"caret\"></span></span></button><div class=\"dropdown-menu open\" style=\"max-height: 267px; overflow: hidden; min-height: 0px;\">"
								...
								+"<li data-original-index=\"0\" class=\"selected\" id=\"li0\" onclick=\"clickLi('"+0+"','Caterer Type')\"><a tabindex=\"0\" class=\"\" style=\"\" data-tokens=\"null\"><span class=\"text\">--Hall Type--</span><span class=\"glyphicon glyphicon-ok check-mark\"></span></a></li>"
						var cde = "";		
	...
	function getMonth(monthStr){
	 ...
	 $("#submit").click(function(e){
		...
		if($("#name").val() === ""){
		...
		}else if((!$("#hallFeatureYes1").is(":checked")) && (!$("#hallFeatureNo1").is(":checked"))){
			swal({
				  title: 'Warning!',
		...
		}else if((!$("#hallFeatureYes2").is(":checked")) && (!$("#hallFeatureNo2").is(":checked"))){
			swal({
				  title: 'Warning!',
		...
		}else if((!$("#hallFeatureYes3").is(":checked")) && (!$("#hallFeatureNo3").is(":checked"))){
			swal({
				  title: 'Warning!',
				  text: 'Please Select Whether You Have Lounge Facility!!!',
				  type: 'warning',
				  confirmButtonText: 'OK',
				  allowEscapeKey:true,
				  confirmButtonClass:"btn btn-raised gradient-right",
		...
		}else if((!$("#hallFeatureYes4").is(":checked")) && (!$("#hallFeatureNo4").is(":checked"))){
			swal({
				  title: 'Warning!',
		...
		}else if((!$("#hallFeatureYes5").is(":checked")) && (!$("#hallFeatureNo5").is(":checked"))){
			swal({
				  title: 'Warning!',
				  text: 'Please Select Whether You Have Any Restrictions For Crackers!!!',
				  type: 'warning',
		...
		}else if((!$("#hallFeatureYes6").is(":checked")) && (!$("#hallFeatureNo6").is(":checked"))){
			swal({
				  title: 'Warning!',
		...
		}else if(($("#hallFeatureYes1").is(":checked")) && ($("#noOfRooms").val() === "")){
			swal({
				  title: 'Warning!',
			...
			job["isExtraBedRooms"] = $("#hallFeatureYes1").is(":checked")? true : false;
			job["isParkingFacility"] = $("#hallFeatureYes2").is(":checked")?true : false;
			job["isLounge"] = $("#hallFeatureYes3").is(":checked")?true : false;
			job["isCrackersAllowed"] = $("#hallFeatureYes4").is(":checked")? true : false;
			job["isExtraSpace"] = $("#hallFeatureYes5").is(":checked")? true : false;
			job["isWifiConnection"] = $("#hallFeatureYes6").is(":checked")? true : false;
			...
			if(i !== ""){
				if(i === Number(1)){
					...
					if(($("#fromDateFreeProduct"+i).val() === $("#fromDateFreeProduct").val()) && ($("#toDateFreeProduct"+i).val() === $("#toDateFreeProduct").val())){
						...
						if(($("#fromDateFreeProduct"+i).val() === $("#fromDateFreeProduct"+Number(Number(i) - Number(1))).val()) && ($("#toDateFreeProduct"+i).val() === $("#toDateFreeProduct"+ Number(Number(i) - Number(1))).val())){
							check = Number(1);
							swal({
								  title : 'Warning!',
								  text: 'You Have Already Entered Price Within The Same Range Of Dates!!!',
